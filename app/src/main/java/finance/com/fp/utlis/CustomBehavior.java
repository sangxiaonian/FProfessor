...
public class CustomBehavior extends CoordinatorLayout.Behavior {
    ...
    public boolean onDependentViewChanged(CoordinatorLayout parent, View child, View dependency) {
        ...
        View ll_et = view.findViewById(R.id.ll_et);
        View rl_bicon = view.findViewById(R.id.rl_bicon);
        View rl_text = view.findViewById(R.id.rl_text);
...
//        return super.onNestedFling(coordinatorLayout, child, target, velocityX, velocityY, consumed);
    ...
    private ValueAnimator animator, expendAnimator;
